...
const places = [
  ...
  },
  {
    ...
    type: "food",
    emoji: "🦆",
    koreanName: "따동 (IFC 몰 지점)",
    chineseName: "大董 (ifc国金中心店)",
    areaKorean: "푸동/루자쭈이",
    info: "상하이 최고의 프리미엄 북경오리 체인. 기름기가 적고 바삭한 껍질이 특징인 '린(Lean)' 스타일 오리로 유명합니다.",
    tips: ["쇼핑몰 내 위치하여 접근성 우수", "동방명주 방문 전후 식사로 추천", "예술적인 플레이팅 감상 필수"],
    tags: ["북경오리", "프리미엄", "IFC몰"],
    lat: 31.2386, lng: 121.4969
  },
  {
    id: "shengyongxing_bund",
    type: "food",
    emoji: "🍷",
    koreanName: "셩용싱 (와이탄 지점)",
    chineseName: "晟永兴 (外滩店)",
    areaKorean: "와이탄",
    info: "미슐랭 1스타 북경오리 레스토랑. 동방명주가 한눈에 보이는 환상적인 리버뷰와 함께 최고급 오리를 즐길 수 있습니다.",
    tips: ["창가 자리 사전 예약 강력 권장", "와인 리스트가 훌륭함", "기념일이나 특별한 날에 추천"],
    tags: ["미슐랭1스타", "리버뷰", "파인다이닝"],
    lat: 31.2345, lng: 121.4920
  },
  {
    id: "sijiminfu_bund",
    type: "food",
    emoji: "🔥",
    koreanName: "사계민복 (와이탄 근처 지점)",
    chineseName: "四季民福烤鸭店 (外滩외백도교점)",
    areaKorean: "와이탄 북쪽",
    info: "가성비와 맛을 모두 잡은 현지 최고의 인기 맛집. 전통 화로 구이 방식의 북경오리를 합리적인 가격에 선보입니다.",
    tips: ["따종디엔핑 앱으로 실시간 대기 확인 추천", "오리 외 베이징 전통 요리도 다양", "대기가 기니 미리 번호표 받기"],
    tags: ["가성비맛집", "현지인추천", "웨이팅지옥"],
    lat: 31.2460, lng: 121.4840
  },
  {
    id: "quanjude_lujiazui",
    type: "food",
    emoji: "📜",
    koreanName: "전취덕 (루자쭈이 인근)",
    chineseName: "全聚德 (紫金山店)",
    areaKorean: "푸동/루자쭈이",
    info: "160년 전통을 자랑하는 북경오리의 원조 브랜드. 가장 정통적이고 클래식한 맛을 고수하는 곳입니다.",
    tips: ["정통 클래식 오리를 찾는 분들께 추천", "루자쭈이 지역 숙소에서 이동 편리", "전통적인 분위기의 인테리어"],
    tags: ["160년전통", "원조맛집", "클래식"],
    lat: 31.2308, lng: 121.5284
  },
  {
    id: "bund",
    type: "attraction",
