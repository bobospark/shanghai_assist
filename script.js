/* ========== 명소 데이터 (확장 버전) ========== */
const hotelLocation = { lat: 31.245, lng: 120.485 }; // 골든 튤립 번드 뉴 아시아 대략 좌표
